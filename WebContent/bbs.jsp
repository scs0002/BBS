	...
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			...
			%>
				...
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button'"
						aria-haspopup="false" aria-expended="false">회원관리<span class="caret"></span></a>
						<ul class="dropdown-menu">
	...
	<div class="container">
		<div class="row">
			...
			<%
				if(pageNumber != 1){
			%>
				<a href="bbs.jsp?pageNumber=<%= pageNumber - 1 %>" class="btn btn-success btn-arrow-lef">이전</a>
			<%
				}if(bbsDAO.nextPage(pageNumber + 1)){
			%>
				<a href="bbs.jsp?pageNumber=<%= pageNumber + 1 %>" class="btn btn-success btn-arrow-lef">다음</a>
			<%
				}
			%>
